...
The homepage will be implemented using HTML5, ES6, and SCSS.
...
- Job openings are defined in a JSON file.
- SVGs will be used for all the icons.
- Final output must be hosted in a publicy available URL (heroku, etc.).
...
- What we're looking for is to see your attention to details and faithfulness to the design.
